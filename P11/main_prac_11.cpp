	...
	if (play) {
		...
		if (estado == 0) {
			if (reversa)
			{
				...
				if (movKit_z > -100)
				{
					...
					estado = 9;//Al estado J (DE REGRESO)
				}
			}
			else
			{
		...
		if (estado == 1) {
			if (reversa) {
				...
				{
					estado = 0; //REGRESANDO A ESTADO B
				}
		...
		if (estado == 3) {
			if (reversa)
			{
				...
				{
					estado = 2; //REGRESANDO A ESTADO D
				}
		...
		if (estado == 4) {
			if (reversa)
			{
				...
				{
					estado = 2; //REGRESANDO A ESTADO E
				}
		...
		if (estado == 5) {
			if (reversa)
			{
				...
				{
					estado = 2; //REGRESANDO A ESTADO F
				}
		...
		if (estado == 6) {
			if (reversa)
			{
				...
				{
					estado = 2; //REGRESANDO A ESTADO G
				}
		...
		if (estado == 7) {
			if (reversa)
			{
				...
				{
					estado = 2; //REGRESANDO A ESTADO H
				}
		...
		if (estado == 8) {
			if (reversa)
			{
				...
				{
					estado = 7; //REGRESANDO A ESTADO H
				}
		...
		if (estado == 9) {
			if (reversa)
			{
				...
				{
					estado = 8; //REGRESANDO A ESTADO I
				}
