...
void display(void)
{
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.750f, 1.0f));
	sphere_draw();	//nucleo
	circulos2(1,1,0);
	circulos2(0,1,1);
	circulos2(1, 0, 1);
	...
	model = glm::scale(model, glm::vec3(0.50f, 0.50f, 0.50f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.50f, 0.50f));
	sphere_draw();	//nucleo
	...
	model = glm::scale(model, glm::vec3(0.50f, 0.50f, 0.50f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.150f, 1.0f));
	sphere_draw();	//nucleo
	model = glm::mat4(1.0f);
	...
	model = glm::scale(model, glm::vec3(0.50f, 0.50f, 0.50f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.50f, 0.50f));
	sphere_draw();	//nucleo
	model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(.5, -.8, 0));
	//model = glm::rotate(model, glm::radians(sol), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::scale(model, glm::vec3(0.50f, 0.50f, 0.50f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.50f, 1.0f));
	sphere_draw();	//nucleo
	model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-.5, -.8, 0));
	//model = glm::rotate(model, glm::radians(sol), glm::vec3(0.0f, 1.0f, 0.0f));
	...
	model = glm::scale(model, glm::vec3(0.50f, 0.50f, 0.50f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.50f, 1.0f));
	sphere_draw();	//nucleo
	model = glm::mat4(1.0f);
	...
	model = glm::scale(model, glm::vec3(0.50f, 0.50f, 0.50f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.0f, 0.150f, 0.50f));
	sphere_draw();	//nucleo
	model = glm::mat4(1.0f);
	model = glm::translate(model, glm::vec3(0, .8, -.8));
	//model = glm::rotate(model, glm::radians(sol), glm::vec3(0.0f, 1.0f, 0.0f));
	...
	model = glm::scale(model, glm::vec3(0.50f, 0.50f, 0.50f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.150f, 0.50f));
	sphere_draw();	//nucleo
	model = glm::mat4(1.0f);
	model = glm::translate(model, glm::vec3(0, -.8, -.8));
	//model = glm::rotate(model, glm::radians(sol), glm::vec3(0.0f, 1.0f, 0.0f));
	...
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(.80f, .60f, 0.97f));
	sphere_draw();
	...
	model = glm::scale(model, glm::vec3(0.30f, 0.30f, .30f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.75f, 0.6f, 0.93f));
	sphere_draw();
	model = glm::mat4(1.0f);
	...
	model = glm::scale(model, glm::vec3(0.30f, 0.30f, .30f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(.180f, .960f, 0.97f));
	sphere_draw();
	model = glm::mat4(1.0f);
	...
	model = glm::scale(model, glm::vec3(0.30f, 0.30f, .30f));
	projectionShader.setMat4("model", model);
	projectionShader.setVec3("aColor", glm::vec3(0.175f, 0.96f, 0.93f));
	sphere_draw();
	model = glm::mat4(1.0f);
